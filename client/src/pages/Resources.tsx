...
const jumpstartChapters = [
  ...
  { title: "Capstone: Putting It All Together", subtitle: "The Master Blueprint", description: "One final prompt that uses everything you've learned. The master template for any task.", image: "/chapters/ch14-putting_it_all_together_small.png", chapterId: null,
